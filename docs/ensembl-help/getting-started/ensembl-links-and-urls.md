...
In this URL, Feature explorer is the app, the UUID identifies the genome dataset, gene:ENSG00000141499 identifies the feature, and view=transcripts selects the view within the app.
