...
- [cmscan](http://eddylab.org/infernal/) (from the Infernal suite) is used to identify structured RNAs
- Searches are performed against [Rfam](https://rfam.org/), a collection of covariance models for RNA families
