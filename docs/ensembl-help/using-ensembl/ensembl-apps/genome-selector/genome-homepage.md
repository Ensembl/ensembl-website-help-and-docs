---
slug: genome-homepage
title: Genome homepage
description: How to navigate the genome homepage
---

# Genome homepage

The Genome homepage provides information about the genome assembly and gene annotation for each species genome, alongside controls to manage your list of species genomes.  

## How to turn a species genome 'on' or 'off'

A species genome can be turned 'on' or 'off' in the Genome homepage by toggling between 'Use' and 'Don't Use', respectively. 
The 'Use' 'Don't Use' toggle button is found next to the Genome homepage header ie the species and assembly names.
...
To find a gene from a Genome homepage select 'Find a gene' or the magnifying glass icon in the Action bar and search for your gene of interest.
...
The Summary panel can be opened and closed using the '>' icon on the right hand side of the Genome homepage. 
...
## How to leave the Genome homepage

To leave the Genome homepage and return to the Genome selector, select '<' or 'Find a species' to the left of the 'Genome homepage' header.
