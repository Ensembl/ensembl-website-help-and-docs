...
You can search for a gene of interest within the Feature explorer and Genome browser apps.
...
A pop-up menu giving details of the gene will pop up with links to the Genome browser and Feature explorer.

![](media/in-app-search-z-menu.png)

To view the gene with in the genome select the Genome browser icon. For details of the gene, its transcripts and proteins select the Feature explorer icon.
