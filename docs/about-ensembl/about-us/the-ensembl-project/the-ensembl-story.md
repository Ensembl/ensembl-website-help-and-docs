...
From 2026, genomes from across the tree of life are available together in a single Ensembl site. This new Ensembl platform will serve all new genome data going forward. We maintain [archives](https://www.ensembl.org/help/articles/archives) for the legacy Ensembl versions, with the latest archives providing advanced tool support until the equivalents are offered on this site.
